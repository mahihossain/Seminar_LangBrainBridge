...
def prepare_fmri_features(train_features, test_features, word_train_indicator, TR_train_indicator, num_delays, SKIP_WORDS=20, END_WORDS=5176):
    ...
    tmp = delay_mat(tmp, np.arange(1,num_delays+1))                                    # (1351, num_delays*10)
...
def run_class_time_CV_fmri_crossval_ridge(data, predict_feat_dict,num_delays,
    ...
    for ind_num in range(n_folds):
        ...
        train_features,test_features = prepare_fmri_features(tmp_train_features, tmp_test_features, word_CV_ind, train_ind,num_delays)
